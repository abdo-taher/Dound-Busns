                            ...
                            <tr>
                                <th scope="row">
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <img src={{ image_url( $type_category->img) }} alt
                                            class="w-px-30 h-auto " />
                                        {{ $type_category->name }}
                                    </div>
                                </th>
                                <td>{{ $type_category->branch->name }}</td>
                                <td>{{ $type_category->code }}</td>
                                <td>{{ $type_category->size }}</td>
                                <td>{{ $type_category->type }}</td>
                                <td>{{ $type_category->grass_type }}</td>
                                <td>{{ $type_category->price.' '.$currency->symbol }}</td>
