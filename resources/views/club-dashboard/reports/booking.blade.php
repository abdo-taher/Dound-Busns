                        ...
                        <tbody>
                            @foreach ($data as $booking)
                                <tr>
                                    ...
                                    <td><span class="badge px-2 bg-label-{{$booking->status=='active'?'success':'warning'}}" text-capitalized=""> {{ $booking->status }} </span></td>
                                    <td class="">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="{{ route('club.reports.show_book', $booking->id) }}"><i class="bx bx-show me-1"></i>
                                                    {{ __('home.Show') }}
                                                </a>
