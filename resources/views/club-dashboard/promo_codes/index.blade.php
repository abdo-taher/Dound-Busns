        ...
        <div class="card">
            <div class="d-flex align-item-center p-4 justify-content-between w-100">
                ...
                <div class="d-flex align-item-center gap-3">
                    ...
                    <a href="{{ route('club.promo_codes.create') }}">
                                ...
                                <td class="">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ route('club.promo_codes.edit', $offer->id) }}"><i
                                    ...
                                    @include('components.modalDelete', [
                                        'action' => 'club.promo_codes.destroy',
                                        'name' => $offer->name,
    ...
    $(document).ready(function() {
        ...
        $('#deleteSelected').click(function() {
            ...
            if (selectedIds.length > 0) {
                $.ajax({
                    url: "{{ route('club.promo_codes.deleteSelected') }}",
                    type: "POST",
        ...
        $('.toggle-activation').change(function() {
            ...
            $.ajax({
                url: "{{ route('club.promo_codes.toggleActivation') }}",
                type: "POST",
                data: { id: adminId },
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
