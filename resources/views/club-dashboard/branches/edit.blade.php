<!-- resources/views/club-dashboard/branches/edit.blade.php -->
                ...
                <div class="col-md-12">
                    <div class="card mb-4 ">
                        <div class="d-flex p-3 px-4 align-items-center justify-content-between w-100">
                            <h5 class="card-header p-0">{{ __('home.edit') }} {{ __('home.branches') }}</h5>
                        ...
                        <div class="card-body">
                            <form action="{{ route('club.branches.update', $data->id) }}" method="POST" class="row"
