...
<head>
    ...
    <title>Sportat Admin - Login</title>
    ...
    <div class="login">
        ...
        <form method="POST" action="{{ route('admin.login') }}">
            ...
            <div class="text-center">
                <button class="login__button" type="submit">تسجيل دخول مشرف</button>
            </div>
        </form>

        <!-- Options for other logins -->
        <!-- Options for other logins -->
        <div class="login-options">
            <a href="{{ route('vendor.login') }}" class="btn btn-link text-white  btn-outline-gray">تسجيل دخول بائع</a>
            <a href="{{ route('club.login') }}" class="btn btn-link text-white btn-outline-gray">تسجيل دخول مالك نادي</a>
        </div>
